...
- 18 páginas: `index.html` (login estático com formulário) + `home`, `dashboard`, `manifests`, `import`, `division`, `work`, `occurrences`, `summary`, `history`, `tablet`, `products`, `alerts`, `emergency`, `settings`, `dalas`, `companies` e `company`.
