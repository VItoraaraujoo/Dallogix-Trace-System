...
import { dalaActions, dalaEdit, dalas, dalaView } from "./telas/dalas.js?v=202609161600";
...
import {
    ...
    products,
    summary,
} from "./telas/monitoramento.js?v=202609161600";
import {
    division,
    importScreen,
    manifestEdit,
...
function installOfflineShell() {
  ...
  navigator.serviceWorker.register("/service-worker.js?v=202609161600").catch(() => {
...
const DALA_SCREEN_STYLES = "/css/dalas-screen.css?v=202609161600";
