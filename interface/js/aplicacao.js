...
import { dalaActions, dalaEdit, dalas, dalaView } from "./telas/dalas.js?v=202609161145";
...
function installOfflineShell() {
  ...
  navigator.serviceWorker.register("/service-worker.js?v=202609161145").catch(() => {
...
const DALA_SCREEN_STYLES = "/css/dalas-screen.css?v=202609161145";
