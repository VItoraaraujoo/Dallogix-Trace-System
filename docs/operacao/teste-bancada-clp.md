...
- Conectar o PC industrial ao CLP por adaptador USB–RS485 industrial.
...
1. Configurar no CLP e no adaptador a mesma velocidade, paridade, bits, stop bits e endereço.
